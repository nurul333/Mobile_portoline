...
class JobHomePage extends StatefulWidget {
  ...
  const JobHomePage({super.key, this.trainerId = 'defaultTrainerId'});
...
class _JobHomePageState extends State<JobHomePage> {
  ...
  Future<void> fetchTrainings() async {
    final url = Uri.parse(
      'http://192.168.56.1/proyek2_mobile/portoline/get_trainings.php?trainer_id=${widget.trainerId}',
    );
            ...
            Expanded(
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return JobCard(
                    image: job['image_url'] ?? 'assets/default.png',
                    title: job['judul'],
